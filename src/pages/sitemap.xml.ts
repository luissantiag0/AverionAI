...
const routes = [
  ...
  { path: "aprende/como-automatizar-ventas-con-ia", priority: "0.7", changefreq: "monthly" },
  { path: "aprende/que-es-crm-automatizacion-inteligente", priority: "0.7", changefreq: "monthly" },
  { path: "aprende/ejemplo-real-sistema-ia-empresas", priority: "0.7", changefreq: "monthly" },
  { path: "precio-automatizacion-ia-empresas", priority: "0.8", changefreq: "monthly" },
  { path: "cuanto-cuesta-crm-ia", priority: "0.8", changefreq: "monthly" },
  { path: "automatizacion-ventas-roi-empresas", priority: "0.8", changefreq: "monthly" },
